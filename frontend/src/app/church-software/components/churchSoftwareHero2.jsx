...
function ChurchSoftwareHero2() {
  return (
    <div>

      <svg viewBox="-50 0 500 458.4" width="250" height="350" style={{
        margin: "35px auto",
        left: "50%",
        display: "block",
      }}>
          ...
          <g clip-path="url(#computer-clip)">
            <g id="computer">
              <g id="screen">
                ...
                <path className="screen" fill="#11191A" d="M239.6,23.2c0-2.3-0.4-2.3-1.7-1.6c-0.5,0.3-1.2,0.7-2,1.2l-211.3,122c-0.8,0.5-1.3,0.7-1.7,0.9 c-0.8,0.5-0.5,0.6-0.5,2.9L22.9,302c0,2.2-0.3,2.7,0.5,2.3c0.3-0.2,0.9-0.6,1.7-1l212-122.4c0.8-0.5,1.4-0.8,1.8-1 c1-0.6,1.1-1,1.1-3.2L239.6,23.2z" />
                ...
                <g>
                  ...
                  <g clip-path="url(#clip-path-screen-2">
                    <g id="scrolling-code">
                      ...
                      <polygon className="code line-1" fill="#7D7E7E" points="144.7,147 144.7,152.9 98.2,179.7 98.2,173.8" />
                      <polygon className="code line-1" fill="#7D7E7E" points="187.7,122.1 187.7,128 149,150.4 149,144.5" />

                      <polygon className="code line-2" fill="#3A4488" points="51.9,211.8 51.9,217.7 29.2,230.8 29.2,224.9" />
                      <polygon className="code line-2" fill="#7D7E7E" points="179.5,138.1 179.5,144 140.8,166.3 140.8,160.4" />
                      <polygon className="code line-2" fill="#7D7E7E" points="136.2,163.1 136.2,169 98.2,191 98.2,185.1" />
                      <polygon className="code line-2" fill="#7D7E7E" points="88.5,190.6 88.5,196.5 56.6,215 56.6,209.1" />

                      <polygon className="code line-3" fill="#CA9733" points="47.7,224.8 47.7,230.7 34.7,238.3 34.7,232.4" />
                      <polygon className="code line-3" fill="#7D7E7E" points="151.4,165 151.4,170.9 126,185.6 126,179.7" />
                      <polygon className="code line-3" fill="#7D7E7E" points="121.2,182.4 121.2,188.3 98.2,201.6 98.2,195.7" />
                      <polygon className="code line-3" fill="#7D7E7E" points="183.9,146.2 183.9,152.1 158.5,166.8 158.5,160.9" />
                      <polygon className="code line-3" fill="#7D7E7E" points="93.9,198.2 93.9,204.1 56.6,225.6 56.6,219.7" />

                      <polygon className="code line-4" fill="#3A4488" points="52,231.8 52,237.7 29.3,250.8 29.3,244.9" />
                      <polygon className="code line-4" fill="#7D7E7E" points="169.8,163.8 169.8,169.7 131.1,192 131.1,186.1" />
                      <polygon className="code line-4" fill="#7D7E7E" points="126.9,188.6 126.9,194.5 98.3,211 98.2,205.1" />
                      <polygon className="code line-4" fill="#7D7E7E" points="89.3,210.3 89.3,216.2 56.7,235.1 56.6,229.1" />

                      <polygon className="code line-5" fill="#3B963D" points="47.8,246.1 47.8,252 34.7,259.5 34.7,253.6" />
                      <polygon className="code line-5" fill="#7D7E7E" points="186.3,166.1 186.4,172 167.8,182.7 167.8,176.8" />
                      <polygon className="code line-5" fill="#7D7E7E" points="163.1,179.5 163.1,185.4 135.4,201.4 135.4,195.5" />
                      <polygon className="code line-5" fill="#7D7E7E" points="93.3,219.8 93.3,225.7 56.7,246.9 56.7,241" />
                      <polygon className="code line-5" fill="#7D7E7E" points="130.7,198.2 130.7,204.1 98.3,222.8 98.3,216.9" />

                      <polygon className="code line-6" fill="#3B963D" points="47.8,256.7 47.8,262.6 34.8,270.2 34.8,264.2" />
                      <polygon className="code line-6" fill="#7D7E7E" points="182.1,178.6 182.1,184.5 158.6,198.1 158.6,192.2" />
                      <polygon className="code line-6" fill="#7D7E7E" points="131.2,208.6 131.2,214.5 98.3,233.5 98.3,227.6" />
                      <polygon className="code line-6" fill="#7D7E7E" points="154.1,195.3 154.2,201.2 135.4,212.1 135.4,206.1" />
                      <polygon className="code line-6" fill="#7D7E7E" points="94,230 94,235.9 56.7,257.5 56.7,251.6" />

                      <polygon className="code line-7" fill="#7D7E7E" points="163.1,200.2 163.1,206.1 131.2,224.5 131.2,218.6" />
                      <polygon className="code line-7" fill="#7D7E7E" points="186.4,186.8 186.4,192.7 167.9,203.4 167.9,197.5" />
                      <polygon className="code line-7" fill="#7D7E7E" points="127,221.1 127,227 98.4,243.5 98.3,237.6" />

                      <polygon className="code line-8" fill="#7D7E7E" points="121.3,235.6 121.4,241.5 98.4,254.7 98.4,248.8" />
                      <polygon className="code line-8" fill="#7D7E7E" points="184.1,199.3 184.1,205.2 158.7,219.9 158.6,214" />
                      <polygon className="code line-8" fill="#7D7E7E" points="151.5,218.1 126.1,232.8 126.1,238.7 151.6,224" />
                    </g>
                  </g>
                ...
                <polygon className="code line-0" fill="#A2A75C" points="33.7,158.5 33.7,164.4 29.1,167.1 29,161.2" />
                <polygon className="code line-0" fill="#7D7E7E" points="114.3,111.9 114.3,117.9 101.3,125.4 101.3,119.5" />
                <polygon className="code line-0" fill="#7D7E7E" points="156.9,87.3 156.9,93.2 119.6,114.8 119.6,108.9" />
                <polygon className="code line-0" fill="#7D7E7E" points="97.1,121.9 97.1,127.8 73.8,141.3 73.7,135.4" />
                <polygon className="code line-0" fill="#C1426F" points="69,138.1 69,144 37,162.5 36.9,156.6" />

                <polygon className="code core" fill="#5CA6AB" points="54.5,177.5 54.5,180.5 51.6,182.3 51.6,179.3" />
                <polygon className="code core" fill="#5CA6AB" points="62.4,177.2 62.4,180.2 52.9,185.6 52.9,182.6" />
                <polygon className="code core" fill="#5CA6AB" points="110.9,140.9 110.9,143.9 107.9,145.7 107.9,142.7" />
                <polygon className="code core" fill="#5CA6AB" points="109.6,133.6 109.6,136.6 100.2,142 100.1,139" />
                <polygon className="code core" fill="#5CA6AB" points="63.7,164.1 63.7,167.1 60.7,168.8 60.7,165.8" />
                <polygon className="code core" fill="#5CA6AB" points="75.8,157.1 75.8,160.1 72.8,161.8 72.8,158.8" />
                <polygon className="code core" fill="#5CA6AB" points="75.8,165.3 75.8,168.3 72.8,170 72.8,167" />
                <polygon className="code core" fill="#5CA6AB" points="110.9,136.9 110.9,139.9 107.9,141.6 107.9,138.6" />
                <polygon className="code core" fill="#5CA6AB" points="97.2,140.6 97.2,143.6 94.3,145.4 94.2,142.4" />
                <polygon className="code core" fill="#5CA6AB" points="97.2,148.8 97.3,151.8 94.3,153.5 94.3,150.5" />
                <polygon className="code core" fill="#5CA6AB" points="97.2,144.7 97.2,147.7 94.3,149.4 94.3,146.4" />
                <polygon className="code core" fill="#5CA6AB" points="110.9,145 110.9,148 107.9,149.7 107.9,146.7" />
                <polygon className="code core" fill="#5CA6AB" points="101.7,150.3 101.7,153.3 98.8,155 98.8,152" />
                <polygon className="code core" fill="#5CA6AB" points="97.3,156.9 97.3,159.9 94.3,161.7 94.3,158.7" />
                <polygon className="code core" fill="#5CA6AB" points="109.6,149.9 109.6,152.9 100.2,158.3 100.2,155.3" />
                <polygon className="code core" fill="#5CA6AB" points="101.7,146.2 101.7,149.2 98.8,150.9 98.7,147.9" />
                <polygon className="code core" fill="#5CA6AB" points="97.3,152.9 97.3,155.9 94.3,157.6 94.3,154.6" />
                <polygon className="code core" fill="#5CA6AB" points="92.6,159.6 92.6,162.6 89.6,164.4 89.6,161.4" />
                <polygon className="code core" fill="#5CA6AB" points="101.7,142.1 101.7,145.1 98.7,146.9 98.7,143.9" />
                <polygon className="code core" fill="#5CA6AB" points="88.1,162.3 88.1,165.3 77.3,171.5 77.3,168.5" />
                <polygon className="code core" fill="#5CA6AB" points="80.5,162.6 80.5,165.6 77.5,167.3 77.5,164.3" />
                <polygon className="code core" fill="#5CA6AB" points="75.8,169.3 75.8,172.3 72.8,174.1 72.8,171" />
                <polygon className="code core" fill="#5CA6AB" points="80.4,154.4 80.5,157.4 77.5,159.1 77.5,156.1" />
                <polygon className="code core" fill="#5CA6AB" points="68.2,173.7 68.2,176.7 65.2,178.5 65.2,175.5" />
                <polygon className="code core" fill="#5CA6AB" points="68.2,169.7 68.2,172.7 65.2,174.4 65.2,171.4" />
                <polygon className="code core" fill="#5CA6AB" points="74.3,162.1 74.3,165.1 64.9,170.6 64.8,167.6" />
                <polygon className="code core" fill="#5CA6AB" points="63.7,172.3 63.7,175.3 60.7,177 60.7,174" />
                <polygon className="code core" fill="#5CA6AB" points="68.1,161.5 68.1,164.5 65.2,166.2 65.2,163.3" />
                <polygon className="code core" fill="#5CA6AB" points="63.7,168.2 63.7,171.2 60.7,172.9 60.7,169.9" />
                <polygon className="code core" fill="#5CA6AB" points="74.3,154 74.3,157 64.8,162.4 64.8,159.4" />
                <polygon className="code core" fill="#5CA6AB" points="54.5,173.5 54.5,176.5 51.6,178.2 51.5,175.2" />
                <polygon className="code core" fill="#5CA6AB" points="115.1,155.1 115.2,156.5 35,202.7 35,201.4" />
                <polygon className="code core" fill="#5CA6AB" points="54.5,169.4 54.5,172.4 51.5,174.1 51.5,171.1" />
                <polygon className="code core" fill="#5CA6AB" points="50.1,184.3 50.1,187.3 40.6,192.7 40.6,189.7" />
                <polygon className="code core" fill="#5CA6AB" points="62.3,160.9 62.3,163.9 52.9,169.3 52.9,166.3" />
                <polygon className="code core" fill="#5CA6AB" points="42.2,184.6 42.2,187.6 39.3,189.4 39.2,186.4" />
                <polygon className="code core" fill="#5CA6AB" points="42.2,176.5 42.2,179.5 39.2,181.2 39.2,178.2" />
                <polygon className="code core" fill="#5CA6AB" points="50,168 50,171 40.6,176.4 40.6,173.4" />
                <polygon className="code core" fill="#5CA6AB" points="115.1,125.6 115.1,127 35,173.2 35,171.8" />
                <polygon className="code core" fill="#5CA6AB" points="85,155.9 85,158.9 77.5,163.3 77.5,160.3" />
                <polygon className="code core" fill="#5CA6AB" points="88.1,146 88.1,149 77.3,155.2 77.3,152.2" />
                <polygon className="code core" fill="#5CA6AB" points="42.2,180.6 42.2,183.6 39.2,185.3 39.2,182.3" />
                ...
                <path className="control red" fill="#C24C4B" d="M31.8,145.3c1.4-0.8,2.6-0.2,2.6,1.5c0,1.6-1.1,3.6-2.6,4.5c-1.4,0.8-2.6,0.2-2.6-1.5
                  C29.3,148.2,30.4,146.2,31.8,145.3z"/>
                <path className="control yellow" fill="#CA9733" d="M40.5,140.4c1.4-0.8,2.6-0.2,2.6,1.5c0,1.6-1.1,3.6-2.6,4.5c-1.4,0.8-2.6,0.2-2.6-1.5 C37.9,143.2,39,141.2,40.5,140.4z" />
                <path className="control green" fill="#3B963D" d="M49.1,135.4c1.4-0.8,2.6-0.2,2.6,1.5s-1.1,3.6-2.6,4.5c-1.4,0.8-2.6,0.2-2.6-1.5S47.7,136.2,49.1,135.4z" />
                <polygon className="control title" fill="#646565" points="142,81.7 142.1,87.6 118.7,101.1 118.7,95.2" />
...
export default ChurchSoftwareHero2