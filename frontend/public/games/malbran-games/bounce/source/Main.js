...
/**
 * Pauses the game (does not work on mobile)
 * @returns {Void}
 */
function startPause() {
  if (isMobile()) {
    // Prevent pausing on mobile devices
    return;
  }

  // Pause functionality for non-mobile devices
  display.set("paused");
  hideGame();
}
...
function initDomListeners() {
  ...
  document.body.addEventListener("click", handleStartEvent);
  document.body.addEventListener("touchstart", handleStartEvent);
}
